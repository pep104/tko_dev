...
interface InventoryApi {
    ...
    suspend fun updateContainerArea(
        @Path("id") id: Long,
        @Body containerArea: ContainerAreaDetailedRequest,
    ): ApiResult<ContainerAreaResponse>
    ...
    @GET("waste-area/")
    suspend fun getContainerAreasByBoundingBox(
    ...
    ): ApiResult<ContainerAreaListResponse>

    @GET
    suspend fun getContainerAreasByBoundingBox(@Url nextPage: String): ApiResult<ContainerAreaListResponse>
